...
import com.example.mytelegram.utilits.AppVoisePlayer
...
class HolderVoiceMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    private val mAppVoicePlayer = AppVoisePlayer()
    ...
    private val chatRecyclerBtnPlay: ImageView = view.chat_received_btn_play
    private val chatRecyclerBtnStop: ImageView = view.chat_received_btn_stop
    ...
    override fun onAttach(view: MessageView) {
        ...
        if (view.from == CURRENT_UID) {
            ...
            chatRecyclerBtnPlay.setOnClickListener {
                chatRecyclerBtnPlay.visibility = View.GONE
                chatRecyclerBtnStop.visibility = View.VISIBLE
                chatRecyclerBtnStop.setOnClickListener {
                    stop {
                        chatRecyclerBtnStop.setOnClickListener(null)
                        chatRecyclerBtnPlay.visibility = View.VISIBLE
                        chatRecyclerBtnStop.visibility = View.GONE
                    }
                }
                play(view) {
                    chatRecyclerBtnPlay.visibility = View.VISIBLE
    ...
    override fun onDettach() {
        ...
        chatRecyclerBtnPlay.setOnClickListener(null)
